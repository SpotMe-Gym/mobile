...
const routines: WorkoutRoutine[] = [
  ...
  { id: '5', name: 'Push Day B', duration: '50 min', exercises: 6, last: 'Never' },
  { id: '6', name: 'Pull Day A', duration: '50 min', exercises: 6, last: 'Never' },
];

const WorkoutItem = ({ item }: { item: WorkoutRoutine }) => (
  <Card className="mb-4 bg-zinc-900 border border-zinc-800">
    <View className="flex-row justify-between items-center">
      ...
      <TouchableOpacity className="h-10 w-10 bg-white/10 rounded-full items-center justify-center active:bg-white/20">
    ...
    <SafeAreaView className="flex-1 bg-background" edges={['top']}>
      <View className="flex-1 px-4">
        <View className="flex-row justify-between items-center mb-6 mt-2">
          ...
          <TouchableOpacity className="bg-blue-600 p-2 rounded-full active:bg-blue-500">
            <Plus color="white" size={24} />
          </TouchableOpacity>
        </View>

        <View className="flex-1 w-full h-full">
          <FlashList<WorkoutRoutine>
            data={routines}
